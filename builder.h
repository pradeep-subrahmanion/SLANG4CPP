...
public:
  ...
  void add_function_prototypes(string _name, TypeInfo _ret_type, vector<TypeInfo> _formals);
  bool check_function_prototypes(string _name, TypeInfo _ret_type, vector<TypeInfo> _formals);
